...
| ----- | ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------- | ------------ | ---- | ------ | ---- |
| M3-16 | **Review queue + findings API (new):** `GET /reviews`, promote/reject/relink, `GET /findings`, and resolution write endpoints | contract tests green; promote writes `human_attested` evidence; reject/resolution state is durable and auditable | API-CONTRACT §4 · DATA-MODEL §7 | M3-10, M3-15 | L    | Heavy  | High |
