...
| R16 | **Embedding call-site rework** — in-DB embedding couples the app to DB extension/IAM behavior, while in-app embedding keeps Mode B simpler                                                                  | P0·P1          | M          | L      | DECISIONS 14 | DEC 14 locked (in-app Go embedder); watch IAM, latency, portability, and backfill-use characteristics once real ingest volume lands            |
